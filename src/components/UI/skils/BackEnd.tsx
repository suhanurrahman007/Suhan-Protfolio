...
const skills = [
  {
    name: "NODE JS",
    icon: <IoLogoNodejs className="text-green-700 text-5xl" />,
    colors: [[83, 166, 48]],
  },
  {
    name: "FIREBASE",
    icon: <IoLogoFirebase className="text-[#F57F17] text-5xl" />,
    colors: [[245, 127, 23]],
  },
  {
    name: "MONGODB",
    icon: <BiLogoMongodb className="text-green-700 text-5xl" />,
    colors: [[44, 117, 37]],
  },
  {
    name: "EXPRESS JS",
    icon: <SiExpress className="text-green-200 text-5xl" />,
    colors: [[156, 185, 17]],
  },
];
